...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.YouTubePlayerViewHolder> {
    ...
    public MusicAdapter(ArrayList<MusicCollection> videoIds, Lifecycle lifecycle, MusicListener listener) {
