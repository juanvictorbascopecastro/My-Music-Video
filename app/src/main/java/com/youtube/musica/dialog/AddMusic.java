...
public class AddMusic extends AlertDialog implements DbMusicListener {
        ...
        public AddMusic(Context context, ArrayList<CategoryCollection> list, String url, String id_video) {
            super(context);
            this.url = url;
            this.list_ctg = list;
        ...
        public AddMusic(Context context, ArrayList<CategoryCollection> list, MusicCollection youTube, Fragment frm) {
            super(context);
